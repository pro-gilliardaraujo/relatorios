...
const META_FALTA_APONTAMENTO = configManager.getMetas('transbordo_diario').faltaApontamento;
...
export const GraficoFaltaApontamentoTransbordo: React.FC<FaltaApontamentoProps> = ({ 
  ...
  const getBarColor = (value: number) => {
    if (value <= meta) return "green.500"; // verde para bom (abaixo ou igual à meta de 10%)
    if (value <= meta * 1.2) return "yellow.500"; // amarelo para médio (até 12%)
    return "red.500"; // vermelho para ruim (acima de 12%)
  };
