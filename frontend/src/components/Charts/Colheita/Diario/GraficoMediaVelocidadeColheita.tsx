...
const defaultData: VelocidadeData[] = [
  { id: '1', nome: 'SEM OPERADOR', velocidade: 6.5 },
  { id: '1292073', nome: 'RENATO SOUZA SANTOS LIMA', velocidade: 7.2 },
  { id: '1292074', nome: 'JOÃO SILVA', velocidade: 8.1 },
  { id: '1292075', nome: 'MARIA OLIVEIRA', velocidade: 9.3 }
];

export const GraficoMediaVelocidadeColheita: React.FC<GraficoMediaVelocidadeProps> = ({ 
  data = [],
  meta = configManager.getMetas('colheita_diario').mediaVelocidade,
  inverterMeta = true,
  exibirCards = false
}) => {
...
export default GraficoMediaVelocidadeColheita; 